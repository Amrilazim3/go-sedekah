...
<template>
                ...
                <div class="mt-2 sm:flex sm:justify-between">
                    <div class="sm:flex">
                        <div class="mr-6 text-sm leading-5 text-gray-500">
                            ...
                            <p>
                                My teeth last week broke becauase i eat to much
                                crab without stop for 3 hours, right now my teeh
                                is look old lady that need to be replace and the
                                cost for replacement is so high
                            </p>
                        </div>
                    </div>
                    <div
    ...
    <div>
        ...
        <p class="text-gray-800">
            <span class="text-indigo-500 font-semibold">Kamal Adli</span>
            donated you $50
        </p>
    </div>
</template>
